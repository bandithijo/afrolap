...
if(isset($_POST['preview_6'])){
    ...
    if($ext == "csv"){
        ...
        echo "<br><form method='post' action='upload_tbl_waktu.php'>";
        ...
        <tr>
            <th colspan='3' class='text-center'>Preview Data</th>
        </tr>
        <tr>
            <th>ID Waktu</th>
            <th>Bulan</th>
        ...
        foreach ($worksheet->getRowIterator() as $row) { // Lakukan perulangan dari data yang ada di csv
            ...
            if($numrow > 1){
                ...
                $idwaktu_td = ( ! empty($idwaktu))? "" : " style='background: #E07171;'"; // Jika idindustri kosong, beri warna merah
                $bulan_td = ( ! empty($bulan))? "" : " style='background: #E07171;'"; // Jika namaindustri kosong, beri warna merah
                $tahun_td = ( ! empty($tahun))? "" : " style='background: #E07171;'"; // Jika namaindustri kosong, beri warna merah
        ...
        <?php
            ...
            echo "<button type='submit' name='import_6' class='btn btn-primary'><span class='glyphicon glyphicon-upload'></span> Import</button>";
        }
